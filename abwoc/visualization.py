...
def plots(smaps):
    '''
    Plots an image of the Sun in multiple wavelengths. Can display
    up to nine images in one figure.
...
def plot_zoom(smaps, x0, y0, xlength, ylength):
    '''
    Plots an image of the Sun zoomed in on a region of interest.
